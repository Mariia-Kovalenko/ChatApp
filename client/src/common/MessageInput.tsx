    ...
    return (
      <div className="p-2 sm:p-4 bg-[#d9e2ec] flex gap-2">
        <input
          ...
          className="flex-1 p-3 rounded bg-white border-[1.3px] border-gray-300 shadow-sm
            focus:outline-none focus:border-[#4a90e2] focus:shadow-[0_0_0_3px_rgba(74,144,226,0.25)]
            transition-all"
        />
